...
runtests : src/test/runtests.o src/magma_cpu.o src/magma_gpu.o src/magma_dgemm_gpu.o src/magma_dgemm_async_gpu.o bindir
...
clean : 
	rm bin/runtests src/test/runtests.o src/magma_cpu.o src/magma_gpu.o src/magma_dgemm_gpu.o src/magma_dgemm_async_gpu.o
